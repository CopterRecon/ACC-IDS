...
from acc_sim.plots import plot_gap_vs_required, plot_host_vs_threshold, plot_speeds, plot_speed_threshold, plot_distance_gap_vs_speed_threshold
...
def main():
    ...
    plot_speed_threshold(
    lead_speeds_kmh=(20, 70, 110),
    d_min=0,d_max=80,u=3.4,h=2.0,dt=0.1)
